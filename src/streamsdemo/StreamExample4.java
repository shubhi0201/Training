...
public class StreamExample4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("*********** Sorted Book Details ******************");
		list.stream().sorted((book1,book2) -> book1.name.compareTo(book2.name)).forEach(b-> System.out.println(b.id+ " "+ b.name+ " "+ b.author+ " "+ b.publisher+ " "+ b.quantity));
		System.out.println("*************** Author name in upperCase");
