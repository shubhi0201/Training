...
CREATE TABLE `skills` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AcandidatescandidatesUTO_INCREMcandidatescandidate_skillscandidate_skillsskillsskillsENT=6 DEFAULT CHARSET=latin1;
...
BEGIN
	...
	INNER JOIN skills ON candidatescandidatesskills.id = candidate_skills.skill_id
